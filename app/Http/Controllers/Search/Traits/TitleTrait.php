    ...
    public function getBreadcrumb()
    {
        ...
        if (isset($this->admin) && !empty($this->admin)) {
            ...
            $bcTab[] = [
                ...
                'url'      => lurl(trans('routes.v-search', ['countryCode' => $this->country->get('icode')])) . '?d=' . $this->country->get('icode') . '&r=' . $this->admin->name,
                'position' => (isset($this->cat) ? 5 : 3),
                'location' => true
            ];
        }
		...
		if (isset($this->company) && !empty($this->company)) {
			$bcTab[] = [
				...
				'url'      => lurl(trans('routes.v-search-company', ['countryCode' => $this->country->get('icode'), 'id' => $this->company->id])),
				'position' => (isset($this->cat) ? 5 : 3),
				'location' => true
			];
		}
