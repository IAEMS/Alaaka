    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">@lang('mail.post_archived_content_1', [
                        'title'     => mb_ucfirst($post->title),
                        'now'       => \Date::now(config('timezone.id'))->formatLocalized('%d %B %Y'),
                    ...
                    @lang('mail.post_archived_content_3', [
                        'dateDel' => $post->updated_at->addDays(config('settings.archived_posts_expiration', 7))->formatLocalized('%d %B %Y')
                    ])
